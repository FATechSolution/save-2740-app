    ...
    <div className="fixed top-4 left-4 right-4 sm:top-6 sm:right-6 sm:left-auto sm:max-w-md z-50 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden backdrop-blur-sm">
        ...
        <div className="p-3 sm:p-5 space-y-3 sm:space-y-4">
          ...
          {/* Action button */}
          <button className="w-full bg-brand-green hover:bg-emerald-600 text-white font-semibold py-2.5 sm:py-3.5 rounded-lg sm:rounded-xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base">
