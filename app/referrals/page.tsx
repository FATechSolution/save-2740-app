...
export default function ReferralsPage() {
  ...
  const referralLink = "save2740.com/invite/alex-j"
            ...
            <CardContent className="flex flex-col items-center text-center p-0">
              ...
              <div className="w-full max-w-md space-y-3 sm:space-y-4 px-2 sm:px-4 md:px-0">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  ...
                  <button
                    onClick={handleCopy}
                    className="w-full sm:w-auto bg-slate-800 hover:bg-slate-700 text-white px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-lg md:rounded-xl transition-colors font-semibold flex items-center justify-center gap-2 shrink-0 shadow-lg text-xs md:text-sm"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
            <Card className="border-none shadow-sm rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 bg-white">
              <CardContent className="p-0 flex flex-col items-center justify-center text-center">
                <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-800 mb-2">0</span>
